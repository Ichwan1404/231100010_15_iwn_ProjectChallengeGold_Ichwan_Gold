    ...
    <><header>
      <div className="OurServicePage">
        <Container>
          ...
          <ul className="sewaTitle-02">Best Car Rental for any kind of trip in (Lokasimu)!</ul>
          <ul className="sewaDesc-02">Sewa mobil di (Lokasimu) bersama Binar Car Rental jaminan harga lebih murah dibandingkan yang lain, kondisi mobil baru, serta <br/>kualitas pelayanan terbaik untuk perjalanan wisata, bisnis, wedding,<br/> meeting, dll.</ul>
          </div>
          <div className="ikon">
