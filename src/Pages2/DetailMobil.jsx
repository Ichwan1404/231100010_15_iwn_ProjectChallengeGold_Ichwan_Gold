    ...
    <Container>
      <Card className="detailcar00">
        <img
          width={333}
          height={160}
          src={data.image || PLACEHOLEDER_URL}
          alt={data.name}
        />
        <Card.Body className="detailcar01">
          ...
          <Card.Text className="detailcar04">
      ...
      <div>
        <Form>
          <Row className="carimobil02">
            ...
            <Col className="hasilkol01">
              ...
              <Input className="hasilkol00" type="select" disabled={true}>
        ...
        <div>
          <List type="unstyled" className="detailmobil00">
            <li className="detailmobil01">Tentang Paket</li>
            <li className="detailmobil02">Include</li>
            ...
            <li className="detailmobil02">Exclude</li>
            <ul className="detailmobil04">
            ...
            <li className="detailmobil03">Refund, Reschedule, Overtime</li>
            <ul className="detailmobil04">
              <li>Tidak termasuk biaya makan sopir Rp 75.000/hari</li>
              <li>
                Jika overtime lebih dari 12 jam akan ada tambahan biaya Rp
